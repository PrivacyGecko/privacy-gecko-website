...
const categoryStyles: Record<string, string> = {
  ...
  "browser-protection": "bg-rose-50 text-rose-700 border-rose-200",
  "file-security": "bg-sky-50 text-sky-700 border-sky-200",
  "passwords-identity": "bg-indigo-50 text-indigo-700 border-indigo-200",
};
