...
export default function AIRoadmapPage() {
  const phases = [
    ...
    {
      phase: "Phase 3: Public AI Launch",
      timeline: "Q4 2025",
      status: "planned" as const,
      statusLabel: "Planned",
      products: [
        "GeckoAdvisor: AI privacy scanning",
        "GeckoGuard: Adaptive blocking",
        "Infrastructure: Full GeckoAI Core Service",
      ],
      features: [
        "Local AI inference operational",
        "Federated learning network live",
        "Token-gated Pro AI features",
    ...
    },
    {
      ...
      statusLabel: "Planned",
      products: [
        "GeckoView: Advanced summarization",
        "GeckoWatch: Predictive compliance",
